...
- Entity: TypeScript account entity class at `backend/src/shared/entity/UserAccount.ts` that represents persisted account data and credential verification behavior.
